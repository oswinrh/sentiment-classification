	...
	<!--HEADER-->
			            	...
			            	<li><a href="home.php">Home</a></li>
			              	<li class="active dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Training<span class="caret"></span></a>
			             		<ul class="dropdown-menu">
			              			<li style="background-color:#91DBCD;"><a href="addlatih.php">Add New Training Document</a></li>
		...
		<div class="panel panel-default" style="background-color:#C8FAF3;">
		  <div class="panel-heading">
		    <h3 class="panel-title">Add A New Training Document</h3>
		  </div>
		  <div class="panel-body">
		    	
			<form action="insertlatih.php" method="POST">

				<div class="form-group">
				<label>Title</label>
				<input type="text" class="form-control" placeholder="Write the film's title here..." name="juduldoklatih">
				</div>

			  	<div class="form-group">
			    <label>Review</label>
			  	<textarea type="text" class="form-control" rows="5" placeholder="Write your review here..." name="isidoklatih" ></textarea>
			  	</div>

			  	<div class="form-group">
				<select name="tag" style="visibility:hidden;">
					<?php
						$td = mysql_query("SELECT tag FROM dokumenlatih WHERE id_doklatih=1");
				...
				<select name="kelas">
					<?php
						$pos = mysql_query("SELECT kelas FROM dokumenlatih GROUP BY kelas");
